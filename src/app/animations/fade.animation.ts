...
const FADE_IN_OUT_SHRINK_SINGLE = trigger('fadeInOutShrinkSingle', [
...
const FADE_IN_SINGLE = trigger('fadeInSingle', [
  transition(':enter', [style({ opacity: 0 }), animate('.3s ease-out', style({ opacity: 1 }))]),
]);
...
export { FADE_IN_LIST, FADE_IN_OUT_LIST, FADE_IN_OUT_SINGLE, FADE_IN_SINGLE, FADE_IN_OUT_SHRINK_SINGLE };
